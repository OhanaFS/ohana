...
<div style={{
  ...
  top: '5px',
  left: '16px'}}>   <Button variant="default" color="dark" size="md" style={{   } } onClick={()=>add()}   >Add {props.addObjectLabel}</Button></td>
       
       <td style={{position: 'absolute',
  top: '5px',
  right: '16px'}}>   <Button variant="default" color="dark" size="md" style={{  }} onClick={()=>deleteGroup() }  >Delete {props.deleteObjectLabel}</Button></td>
