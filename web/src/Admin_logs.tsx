...
import { Card, Grid, useMantineTheme, Button, Center, ScrollArea, Table } from "@mantine/core";
...
const ths =  props.tableHeader.map((items) => (
    ...
    <th style={{ width: "20%", textAlign: "left", fontWeight: "700", fontSize: "16px", color: "black" }}>{items}</th>
...
<tr>
    ...
    <td width="20%" style={{ textAlign: "left", fontWeight: "400", fontSize: "16px", color: "black" }}>{items["Total Files"]}</td>
    <td width="20%" style={{ textAlign: "left", fontWeight: "400", fontSize: "16px", color: "black" }}>{items["Start Time"]}</td>
    <td width="20%" style={{ textAlign: "left", fontWeight: "400", fontSize: "16px", color: "black" }}>{items["End Time"]}</td>
    <td width="20%" style={{ textAlign: "left", fontWeight: "400", fontSize: "16px", color: "black" }}>{items["Maintenance Type"]}</td>
    </tr>
