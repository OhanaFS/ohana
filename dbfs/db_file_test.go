...
func TestFile(t *testing.T) {
	...
	t.Run("CreateFolderByPath", func(t *testing.T) {
		...
		innerFolder, err := dbfs.CreateFolderByPath(db, "/Test2/Test_2", &superUser, "testserver")
		Assert.Nil(err)
	...
	t.Run("Delete Folder By Id", func(t *testing.T) {
		...
		folder, err := dbfs.CreateFolderByPath(db, "/Test2", &superUser, "testserver")
		Assert.Nil(err)
		folder, err = dbfs.CreateFolderByPath(db, "/Test2/Test_2", &superUser, "testserver")
		Assert.Nil(err)
		...
		_, err = dbfs.CreateFolderByPath(db, "/Test3", &superUser, "testserver")
		Assert.Nil(err)
		_, err = dbfs.CreateFolderByPath(db, "/Test3/TestA", &superUser, "testserver")
		Assert.Nil(err)
		_, err = dbfs.CreateFolderByPath(db, "/Test3/TestA/TestA_1", &superUser, "testserver")
		Assert.Nil(err)
		_, err = dbfs.CreateFolderByPath(db, "/Test3/TestA/TestA_2", &superUser, "testserver")
		Assert.Nil(err)
		_, err = dbfs.CreateFolderByPath(db, "/Test3/TestA/TestA_1/POG", &superUser, "testserver")
		Assert.Nil(err)
		_, err = dbfs.CreateFolderByPath(db, "/Test3/TestB", &superUser, "testserver")
		Assert.Nil(err)
		_, err = dbfs.CreateFolderByPath(db, "/Test3/TestB/TestB_1", &superUser, "testserver")
		Assert.Nil(err)
		_, err = dbfs.CreateFolderByPath(db, "/Test3/TestB/TestB_2", &superUser, "testserver")
		Assert.Nil(err)
		_, err = dbfs.CreateFolderByPath(db, "/Test3/TestC", &superUser, "testserver")
		Assert.Nil(err)
	...
	t.Run("Checking permissions for users", func(t *testing.T) {
		...
		parentFolder, err := dbfs.CreateFolderByPath(db, "/TestPerms", &superUser, "testserver")
		Assert.Nil(err)

		subFolder1, err := dbfs.CreateFolderByPath(db, "/TestPerms/perm1", &superUser, "testserver")
		Assert.Nil(err)

		subFolder2, err := dbfs.CreateFolderByPath(db, "/TestPerms/perm2", &superUser, "testserver")
		Assert.Nil(err)
		...
		subFolder3, err := dbfs.CreateFolderByPath(db, "/TestPerms/perm1/perm3", user1, "testserver")
		Assert.Error(err, dbfs.ErrNoPermission)
		subFolder3, err = dbfs.CreateFolderByPath(db, "/TestPerms/perm1/perm3", &superUser, "testserver")
		Assert.Nil(err)
	...
	t.Run("Creating fake files", func(t *testing.T) {
		...
		// Making folders
		newFolder, err := dbfs.CreateFolderByPath(db, "/TestFakeFiles", &superUser, "testserver")
		Assert.Nil(err)
